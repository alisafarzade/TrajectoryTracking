...
while 1:
    ...
    alpha_1 = _x2d_1 + (A * k1 * z1_1 * _wd_1)
    z2_1 = alpha_1 - _x2_1
    ...
    Xi1_2 = _wd_2 + (k3 * (_thetad_2 - angle_2))
    z1_2 = _x3d_2 - _x3_2
    A = pow(le1,2) - pow(z1_2,2)
    alpha_2 = _x2d_2 + (A * k1 * z1_2 * _wd_2)
    z2_2 = alpha_2 - _x2_2
    ...
    Xi2_2 = alphadot_2 + (B * k2 * z2_2 * pow(_wd_2,2)) + ((B / A) * k5 * z1_2 * _wd_2)
    ...
    Xi1_3 = _wd_3 + (k3 * (_thetad_3 - angle_3))
    z1_3 = _x3d_3 - _x3_3
    A = pow(le1,2) - pow(z1_3,2)
    alpha_3 = _x2d_3 + (A * k1 * z1_3 * _wd_3)
    z2_3 = alpha_3 - _x2_3
    ...
    Xi2_3 = alphadot_3 + (B * k2 * z2_3 * pow(_wd_3,2)) + ((B / A) * k5 * z1_3 * _wd_3)
