...
float rawVoltageL, rawVoltageR, kpR = 0.3, kpL = 0.3;
float ki_R = 6.0, ki_L = 6.0;
float kd_R = 0.01 , kd_L = 0.01;
...
//		
		...
		*/
		...
		/*
		delta_time = (HAL_GetTick() - last_time)/1000.0; // in Seconds
		if(HAL_GetTick() - last_time > 200){
			...
			last_Xi2 = Xi2;
			last_x3 = _x3;
			last_time = HAL_GetTick(); // in Miliseconds
		}
		*/
		Xi_Virtual[0] = Xi1;
		Xi_Virtual[1] = Xi2;
