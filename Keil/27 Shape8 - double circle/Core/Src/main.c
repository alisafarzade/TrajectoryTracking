...
float k1 = 10.0,k2 = 10.0,k3 = 3.0, k4 = 1.0, k5 = 1.0, k41 = 2, k42 = 2;
float V, w;
...
float xcd(float time){
	int cycle = ((time*speed)/(2*pi));
	if(cycle%2 == 1)
		return 0.30 * cos(time*speed) - 0.3;
	else
		return - 0.30 * cos(time*speed) + 0.3;
}
float ycd(float time){
	return 0.30 * sin(time*speed);
}
float thetad(float time){
	int cycle = ((time*speed)/(2*pi));
	float theta;
	if(cycle%2 == 1)
		theta = atan2(0.30*cos(time*speed), -0.30*sin(time*speed));
	else
		theta = atan2(0.30*cos(time*speed), 0.30*sin(time*speed));
